...
BoxMesh::BoxMesh(QVector3D a, QVector3D b, QVector3D c, QVector3D d,
                 QVector3D e, QVector3D f, QVector3D g, QVector3D h, QColor boxColor)
{
    m_vertices.push_back(a); // a = 0
    m_vertices.push_back(b); // b = 1
    m_vertices.push_back(c); // c = 2
    m_vertices.push_back(d); // d = 3

    m_vertices.push_back(e); // e = 4
    m_vertices.push_back(f); // f = 5
    m_vertices.push_back(g); // g = 6
    m_vertices.push_back(h); // h = 7
